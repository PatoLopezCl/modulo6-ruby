...
def capicua(n)
    #invertir
    #if n = ninverso ==> capicua!
    print "Ingrese el número que desea evaluar: "
    numero = gets().chomp("\n")
    igual, aux = 0, numero.length - 1
    0.step numero.length - 1 do |n|
    if numero[n] == numero[aux]
    igual += 1
    end
    aux -= 1
    end
